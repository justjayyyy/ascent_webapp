...
export const translations = {
  en: {
    ...
    canAccessDashboard: 'Can access dashboard and analytics',
  ...
  he: {
    ...
    canAccessDashboard: 'יכול לגשת ללוח בקרה וניתוח',
  ...
  ru: {
    ...
    canAccessDashboard: 'Может получить доступ к панели и аналитике',
